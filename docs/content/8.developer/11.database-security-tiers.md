...
| `foods` | Custom food items created by the user | Owner or Delegate with `can_manage_diary` | Delegate with `can_view_food_library`, `can_manage_diary`, or `can_view_reports` |
